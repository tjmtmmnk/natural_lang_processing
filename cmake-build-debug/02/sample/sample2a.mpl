program change;  /* sample2a.mpl */ { compute change program. What is change? }
  ...
  procedure kazuyomikomi(n : integer); begin writeln('input the number of data'); readln(n); return end;
...
end; var n : integer; flag : boolean; begin call kazuyomikomi(n); call goukei(n * 2, sum); call wakakidasi;
